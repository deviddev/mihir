    ...
    <div class="flex flex-col h-full space-y-4">
        ...
        <div class="flex justify-between items-center">
            <div class="relative lg:tooltip" data-tip="Like this post" x-data="likeMaterial(
                ...
                <button class="inline-flex items-center gap-x-1" x-on:click="toggleLike">
                    <x-heroicon-o-hand-thumb-up x-cloak class="inline-flex size-6 hover:stroke-primary"
                        x-bind:class="{
                            'stroke-primary fill-primary': isLiked,
                            'stroke-stone-800 dark:stroke-stone-300': !isLiked
                        }" />
                    <span class="opacity-70 text-sm" x-text="likesCount > 0 ? likesCount : null">
                    </span>
                </button>
            </div>
            <div class="relative lg:tooltip" data-tip="Disike this post" x-data="dislikeMaterial(
                ...
                <button class="inline-flex" x-on:click="toggleDislike">
                    <x-heroicon-o-hand-thumb-down x-cloak class="inline-flex size-6 hover:stroke-primary"
                        x-bind:class="{
            ...
            <div class="relative lg:tooltip" data-tip="Bookmark" x-data="bookmarkMaterial(
                ...
                <button class="inline-flex" x-on:click="toggleBookmark">
                    <x-heroicon-o-bookmark x-cloak class="inline-flex size-6 hover:stroke-primary"
                        x-bind:class="{
            ...
            @if ($material->isPodcast())
                <div class="relative lg:tooltip lg:tooltip-left" data-tip="Play/Pause">
                    <button class="inline-flex"
                        ...
                        <x-heroicon-o-play
                            class="inline-flex size-6 hover:stroke-primary stroke-stone-800 dark:stroke-stone-300" />
                    </button>
                    <button class="inline-flex" x-on:click="$dispatch('pause-podcast')"
                        x-show="$store.mainPodcastPlayer.url === '{{ $material->url }}' && $store.mainPodcastPlayer.isPlaying">
                        <x-heroicon-o-pause
                            class="inline-flex size-6 hover:stroke-primary stroke-stone-800 dark:stroke-stone-300" />
                    </button>
            ...
            @elseif ($material->isYoutube())
                <div class="relative lg:tooltip lg:tooltip-left" data-tip="Play">
                    <button class="inline-flex"
                        x-on:click="() => {
                            $dispatch('open-material-modal', {
                                slug: '{{ $material->slug }}'

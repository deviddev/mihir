<section class="container mx-auto">
    <div class="hero py-20">
        <div class="hero-content text-center">
            <div class="space-y-8">
                <div class="max-w-3xl mx-auto flex justify-center gap-x-4 max-sm:hidden" x-init="change"
                    x-data="{
                    ...
                    <div
                        class="flex items-center gap-x-1 rounded-btn w-fit py-2 px-3 border border-primary text-primary text-xs font-semibold">
                        <x-heroicon-s-microphone class="size-4"
                    ...
                    <div
                        class="flex items-center gap-x-1 rounded-btn w-fit py-2 px-3 border border-primary text-primary text-xs font-semibold">
                        <x-heroicon-s-video-camera class="size-4"
                ...
                <h2 class="max-w-3xl mx-auto">
                    Stay on top of the latest news, updates, and trends in the Laravel ecosystem with our curated
                    content
                    from your favorite and most trusted blogs, YouTube channels, and podcasts, all presented in a

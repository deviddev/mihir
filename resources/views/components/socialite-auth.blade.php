<div class="space-y-2">
    <a class="btn bg-white dark:bg-stone-900 hover:bg-stone-50 dark:hover:bg-stone-800 border border-stone-300 dark:border-none w-full min-h-10 h-10 dark:text-stone-300"
        href="{{ route('socialite.redirect', 'google') }}">
        <svg viewBox="0 0 128 128" class="size-6">
            <path fill="#fff"

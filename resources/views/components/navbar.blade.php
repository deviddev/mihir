<nav class="container mx-auto pt-4">
    <div class="navbar bg-white dark:bg-black rounded-box w-auto max-sm:mx-4">
        <div class="navbar-start">
            <div class="dropdown">
                <div tabindex="0" role="button" class="btn btn-ghost lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 stroke-primary" fill="none"
                ...
                <ul tabindex="0"
                    ...
                    <li>
                        <a class="hover:bg-accent dark:hover:bg-black active:!bg-accent dark:active:!bg-black focus:!bg-accent dark:focus:!bg-black active:!text-inherit"
        ...
        <div class="navbar-center">
            <ul class="menu menu-horizontal px-1 font-semibold hidden lg:flex">
                <li>
                    <a class="hover:bg-accent dark:hover:bg-stone-900 active:!bg-accent dark:active:!bg-stone-900 focus:!bg-accent dark:focus:!bg-stone-900 active:!text-inherit"
                        href="{{ route('home') }}" wire:navigate>
                        {{ __('nav.home') }}
                    </a>
                </li>
        ...
        <div class="navbar-end gap-x-2">
            ...
            <a wire:navigate
                ...
                href="{{ route('register') }}">
                {{ __('misc.sign_up') }} <span class="max-sm:hidden">{{ __('misc.now') }}</span>
            </a>
        </div>
    </div>
</nav>

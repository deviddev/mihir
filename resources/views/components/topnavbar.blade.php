    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-x-6">
            <div class="flex items-center max-lg:hidden">
                <button x-cloak x-data x-on:click="$store.themeMode.toggle()">
                    <x-heroicon-o-sun x-show="$store.themeMode.isDark()" class="inline-flex size-8" />
                    <x-heroicon-o-moon x-show="!$store.themeMode.isDark()" class="inline-flex size-8" />
                </button>
            </div>
            @auth

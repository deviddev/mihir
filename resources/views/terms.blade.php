    ...
    <div class="space-y-20">
        ...
        <div class="container mx-auto">
            <div class="sm:max-w-3xl sm:mx-auto mx-4 space-y-8">
                ...
                <div>
                    <h2 class="font-semibold text-lg mb-4"> Takedown Requests </h2>
                    <p class="opacity-70">
                ...
                <div>
                    <h2 class="font-semibold text-lg mb-4"> Third-Party Content Disclaimer </h2>
                    <p class="opacity-70">
                ...
                <div>
                    <h2 class="font-semibold text-lg mb-4"> Children’s Use </h2>
                    <p class="opacity-70">
                        Larasense.com is not intended for use by individuals under the age of 13.
                    </p>
                    <ul class="list-disc list-inside mt-4 opacity-70">
                        <li>If you are under 13, please do not use this site or provide any personal information.</li>
                        <li>Parents or guardians are encouraged to monitor their children’s online activity.</li>
                    </ul>
                </div>
                ...
                <div>
                    <h2 class="font-semibold text-lg mb-4"> Intellectual Property </h2>
                    <ul class="list-disc list-inside opacity-70">
                        <li> The Larasense.com logo, design, and other proprietary assets are owned by us.</li>
